 ...
 */
object AppConfig {
    lateinit var ANG_PACKAGE: String
    ...
    const val BROADCAST_ACTION_SERVICE = "sp.xray.lite.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "sp.xray.lite.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "sp.xray.lite.action.widget.click"
