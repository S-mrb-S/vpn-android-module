...
import sp.xray.lite.databinding.ActivityXUserAssetUrlBinding
...
class UserAssetUrlActivity : BaseActivity() {
    private lateinit var binding: ActivityXUserAssetUrlBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityXUserAssetUrlBinding.inflate(layoutInflater)
