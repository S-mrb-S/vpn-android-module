...
import sp.xray.lite.databinding.ActivityXAboutBinding
import sp.xray.lite.extension.toast
import sp.xray.lite.util.SpeedtestUtil
import sp.xray.lite.util.Utils
import sp.xray.lite.util.ZipUtil
import java.io.File
import java.text.SimpleDateFormat
import java.util.Locale

class AboutActivity : BaseActivity() {
    private lateinit var binding: ActivityXAboutBinding
    private val extDir by lazy { File(Utils.backupPath(this)) }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityXAboutBinding.inflate(layoutInflater)
        ...
        "v1.8.25 (${SpeedtestUtil.getLibVersion()})".also {
    ...
    fun backupConfiguration(outputZipFilePos: String): Pair<Boolean, String> {
        ...
        val folderName = "${getString(R.string.app_x_name)}_${dateFormated}"
