...
import sp.xray.lite.databinding.ActivityXBypassListBinding
...
class PerAppProxyActivity : BaseActivity() {
    private lateinit var binding: ActivityXBypassListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityXBypassListBinding.inflate(layoutInflater)
...
//                }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.menu_x_bypass_list, menu)
