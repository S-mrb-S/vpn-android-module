...
import sp.xray.lite.databinding.ItemXRecyclerUserAssetBinding
import sp.xray.lite.dto.AssetUrlItem
import sp.xray.lite.extension.toTrafficString
...
class UserAssetActivity : BaseActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.menu_x_asset, menu)
...
//            file with name == item.second.remarks
    ...
    class UserAssetViewHolder(val itemUserAssetBinding: ItemXRecyclerUserAssetBinding) :
