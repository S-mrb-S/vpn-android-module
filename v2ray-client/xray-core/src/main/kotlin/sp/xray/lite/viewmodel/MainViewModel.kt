package sp.xray.lite.viewmodel
...
import sp.xray.lite.databinding.DialogXConfigFilterBinding
import sp.xray.lite.dto.EConfigType
import sp.xray.lite.dto.ServerConfig
import sp.xray.lite.dto.ServersCache
...
import sp.xray.lite.util.MmkvManager.KEY_ANG_CONFIGS
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun filterConfig(context: Context) {
        ...
        val ivBinding = DialogXConfigFilterBinding.inflate(LayoutInflater.from(context))
