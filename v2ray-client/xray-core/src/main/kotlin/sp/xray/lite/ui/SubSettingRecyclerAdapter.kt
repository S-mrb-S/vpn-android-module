...
import sp.xray.lite.databinding.ItemXRecyclerSubSettingBinding
...
class SubSettingRecyclerAdapter(val activity: SubSettingActivity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        return MainViewHolder(
            ItemXRecyclerSubSettingBinding.inflate(
    ...
    class MainViewHolder(val itemSubSettingBinding: ItemXRecyclerSubSettingBinding) :
