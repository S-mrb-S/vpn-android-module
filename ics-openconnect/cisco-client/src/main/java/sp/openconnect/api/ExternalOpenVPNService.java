...
import sp.openconnect.core.OpenVPN.ConnectionStatus;
import sp.openconnect.core.OpenVpnService;
import sp.openconnect.core.OpenVpnService.LocalBinder;
...
public class ExternalOpenVPNService extends Service {
	...
	private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
		...
		public void startProfile(String profileUUID) throws RemoteException {
			...
			shortVPNIntent.setClass(getBaseContext(),sp.openconnect.LaunchVPN.class);
			shortVPNIntent.putExtra(sp.openconnect.LaunchVPN.EXTRA_KEY,profileUUID);
