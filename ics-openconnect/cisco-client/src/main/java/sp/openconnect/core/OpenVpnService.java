...
public class OpenVpnService extends VpnService {
    ...
    public static final String START_SERVICE = "sp.openconnect.START_SERVICE";
    public static final String START_SERVICE_STICKY = "sp.openconnect.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "sp.openconnect.NOTIFICATION_ALWAYS_VISIBLE";

    public static final String ACTION_VPN_STATUS = "sp.openconnect.VPN_STATUS";
    public static final String EXTRA_CONNECTION_STATE = "sp.openconnect.connectionState";
    public static final String EXTRA_UUID = "sp.openconnect.UUID";
