...
import sp.openconnect.core.OpenVPN;
...
public class SendDumpFragment extends Fragment  {
	...
	public void emailMiniDumps()
	{
		...
		uris.add(Uri.parse("content://sp.openconnect.FileProvider/" + ldump.getName()));
		uris.add(Uri.parse("content://sp.openconnect.FileProvider/" + ldump.getName() + ".log"));
