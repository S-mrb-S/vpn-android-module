...
package sp.openconnect.fragments;
...
public class TokenDiagFragment extends Fragment {
	...
	public static final String EXTRA_PIN = "sp.openconnect.PIN";
	public static final String EXTRA_PIN_PROMPTED = "sp.openconnect.PIN_PROMPTED";
